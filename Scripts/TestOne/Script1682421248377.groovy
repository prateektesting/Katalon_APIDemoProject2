...
response1 = WS.sendRequestAndVerify(findTestObject('CountryInfoSoapService/GetCountryListByNames'))
...
response2 = WS.sendRequest(findTestObject('CountryInfoSoapService/GetCapital'))
